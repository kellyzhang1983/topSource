...
import com.zkcompany.interceptor.AuthorizationRocketFilter;
...
public class WebOrderSecurityConfig implements WebMvcConfigurer {
    ...
    @Autowired
    private AuthorizationRocketFilter authorizationRocketFilter;
    ...
    public SecurityFilterChain FilterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(authorizationRocketFilter , UsernamePasswordAuthenticationFilter.class);
