...
import com.zkcompany.interceptor.AuthorizationSearchFilter;
...
@Configuration
@Slf4j
public class WebSearchSecurityConfig {
    ...
    @Autowired
    private AuthorizationSearchFilter authorizationSearchFilter;
    @Bean
    ...
    public SecurityFilterChain FilterChain(HttpSecurity http) throws Exception {
            ...
            public void customize(ExceptionHandlingConfigurer<HttpSecurity> httpSecurityExceptionHandlingConfigurer) {
                httpSecurityExceptionHandlingConfigurer.authenticationEntryPoint(new AuthenticationEntryPoint() {
                    ...
                    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException, ServletException {
                        ...
                        Object message = redisTemplate.boundValueOps(SystemConstants.redis_errorSecuritySearchService_message).get();
                        if(Objects.isNull(message)){
                            message = "用户认证服务失败！请查看异常信息";
                        }else {
                            redisTemplate.delete(SystemConstants.redis_errorSecuritySearchService_message);
                        }
        ...
        http.addFilterBefore(authorizationSearchFilter , UsernamePasswordAuthenticationFilter.class);
