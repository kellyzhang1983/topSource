...
import com.zkcompany.interceptor.AuthorizationMarketFilter;
...
@Configuration
@Slf4j
public class WebMarketSecurityConfig implements WebMvcConfigurer {
    ...
    @Autowired
    private AuthorizationMarketFilter authorizationMarketFilter;
    ...
    public SecurityFilterChain FilterChain(HttpSecurity http) throws Exception {
                ...
                httpSecurityExceptionHandlingConfigurer.authenticationEntryPoint(new AuthenticationEntryPoint() {
                    ...
                    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException, ServletException {
                        ...
                        if(Objects.isNull(message)){
                            ...
                            redisTemplate.delete(SystemConstants.redis_errorSecurityMarketService_message);
                        }
        ...
        http.addFilterBefore(authorizationMarketFilter , UsernamePasswordAuthenticationFilter.class);
