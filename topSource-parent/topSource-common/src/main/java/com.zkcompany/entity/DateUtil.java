...
public class DateUtil {
    ...
    /***
     * 从字符串转换成标准的日期格式：yyyy-MM-dd HH:mm:ss
     * @param dateStr
     * @return
     */
    public static Date formatStr(String dateStr,String opattern){
    ...
    public static Date toDayParten(Date date,int hour){
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
